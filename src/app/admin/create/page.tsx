...
export default function AdminCRUD() {
    ...
    const getAdmin = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            const url = `http://localhost:3000/api/admin/account?ssn=${encodeURIComponent(
                getSsn
            )}`;
    ...
    const deleteAdmin = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(
                `http://localhost:3000/api/admin/account?ssn=${deleteSsn}`,
                {
                    method: "DELETE",
                }
            );
    ...
    return (
        <div>
            ...
            <section>
                ...
                <p>
                    Note: Use the GET section to load an administrator, then
